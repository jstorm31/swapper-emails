...
export const SurveySellersEmail = () => {
    return (
        <SwapperLayout previewText="Vyhrajte 2 lístky na Rock for People 2026 🤘">
            ...
            <Text style={paragraph}>
                Nedávno jste přes Swapper úspěšně prodali lístek. Věnujte nám necelou minutu, ohodnoťte váš prodej a
                automaticky vás zařadíme do slosování.
            </Text>

            <Section style={btnContainer}>
                <Button style={button} href="https://www.swapper.cz/raffle-2026?segment=seller">
...
export default SurveySellersEmail;
